...
3. Revisit transport architecture if request-time token injection or mid-session credential rotation requires more than the current connection/startup-time header model.
